...
**Test coverage**: 192 tests across 16 files covering setup.sh, pre-setup.sh, all zsh conf.d modules (00-70), autoloaded functions, darwin defaults, and config file validation.
...
shellcheck setup.sh ai-agent/claude/pre-setup.sh platform/darwin/defaults.sh
...
See `ai-agent/claude/setup.md` for full environment setup guide.
...
| Claude Code setup | See `ai-agent/claude/setup.md` (15 plugins, 6 MCP servers, RTK, claude-hud) |
